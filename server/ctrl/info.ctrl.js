...
var cli_finder_1 = require("../handlers/cli-finder");
var PersonalCtrl = /** @class */ (function (_super) {
    ...
    PersonalCtrl.prototype.initListeners = function () {
        ...
        this.ipcMain.on('getCliOptions', function () { return __awaiter(_this, void 0, void 0, function () {
            var cliFinder, options, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cliFinder = new cli_finder_1.CliFinder(os.platform());
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
